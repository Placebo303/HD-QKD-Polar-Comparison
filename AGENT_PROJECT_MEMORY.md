> **最新条目在文件尾部**（tail）；头部为历史区（head stale，当前头为 2026-09-14 D13）。读最新状态请从第 4226 行起（`## 2026-09-21 Prior/calibration cost triple-audit`）；验证：`grep -n '^## 2026' AGENT_PROJECT_MEMORY.md | tail`。
