...
def main():
    ...
    results = {
        ...
        "lifecycle": "DEVELOPMENT_RESULT_CANDIDATE / DECODER_FREE_EXECUTION_COMPLETE",
        "V72_not_started": True,
        "no_run_01": True,
        "target_f_planning": TARGET_F_PLANNING,
        "planning_f_is_not_achieved_f": True,
        "f_actual": "NOT_MEASURED",
        "decoder_calls": 0,
        ...
        "used_test": False,
        "accepted_plan_sha": "0509d10ba78902b36f6bcf447f1ebfe289e03fc89b",
        "initial_implementation": "179916f7cfec0ea469683bb78083c3752700193d",
        "contract_sha": "99e6b25f1e7d14ae5168acabc3e4c42e31dafd4d",
        "current_sha": "36d493d82c640f3902c5a7dcd603fdcbb2b03aef",
        "four_stage_provenance": "0509d10b/179916f7/99e6b25f/36d493d8",
        "predecessor_v71": "487be11387a5a68c275c43ccb5528ec700bfd3d3",
        "predecessor_v70": "9bc34be64a2822c8babb4320efb47fc7e335a21a",
        "data_sha": "84d62779",
        "rerun": False,
        "plan_revision": {"revision": "V70R1-R2", "mechanical_reclassification": True, "rerun": False, "note": "insert REDUCES_VAL_CE, cost descriptive-only"},
        "terminal_priority_note": "CHANGES(1) precedes REDUCES(2): overall is first non-zero terminal, not majority count",
        "PRE_RESULT_ORDERING_DEVIATION": True,
