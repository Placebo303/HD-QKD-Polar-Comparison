#!/usr/bin/env python3
"""V72P2D4R1 CAL GF32 model rate audit runner — CAL-only frame-blocked nested.
...
MODULE_PATH = (
    ...
    / "comparison_bench"
    / "formal_ir"
    / "v72p2d4r1_cal_gf32_model_rate_audit.py"
)
...
PRODUCTION_ROOT = (
    ...
    / "comparison_bench"
    / "outputs_comparison"
    / "v72p2d4r1_cal_gf32_model_rate_audit_20260905"
).resolve()
PREP_LIMIT_S = 300.0
G_LIMIT_S = 300.0
INV_LIMIT_S = 600.0
...
def load_audit_module() -> Any:
    spec = importlib.util.spec_from_file_location(
        "v72p2d4r1_cal_gf32_model_rate_audit", str(MODULE_PATH)
    )
