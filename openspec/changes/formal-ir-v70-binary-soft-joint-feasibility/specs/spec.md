...
- **Branch**: `formal-ir-mainline`；`HEAD` `9bc34be64a2822c8babb4320efb47fc7e335a21a` (implementation 9bc34be6, provenance deviation registry/report 9825d0b336042ad4bf2b26ed31b7fa09a04de620 vs 9bc34be6) 重核，不一致阻塞；已与`git rev-parse HEAD`一致。`TBD` 0 hits。
