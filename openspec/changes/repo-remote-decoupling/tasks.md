...
| T3 | COMPLETED_FOR_NAMED_REFS | Comparison `main` remained default; `formal-ir-mainline` was transferred at `d7acfd28`; `formal-ir-v72p1-addendum-clean` remained at `a393f839`; current named branch upstreams point to Comparison `origin`. |
