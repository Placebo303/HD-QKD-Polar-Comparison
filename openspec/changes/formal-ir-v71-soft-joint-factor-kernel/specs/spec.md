...
- **Branch**: `formal-ir-mainline`；`HEAD` `dc18fd2fc17a606fb3a05713efdd9f05ed6472a4` (implementation TBD, provenance deviation registry/report dc18fd2fc17a606fb3a05713efdd9f05ed6472a4 vs 9bc34be6) 重核，不一致阻塞；已与`git rev-parse HEAD`一致。`TBD` 0 hits。
