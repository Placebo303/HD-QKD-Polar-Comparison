...
**Change**: `formal-ir-v71-soft-joint-factor-kernel` (`V71-SJK`, branch `formal-ir-mainline`, HEAD `TBD_new_plan_SHA` implementation TBD, provenance deviation 9825d0b336042ad4bf2b26ed31b7fa09a04de620 vs predecessor 9bc34be6, data `84d62779`, 3 sessions复用V69 Stage2 (E benchmark仅1M 1/9/1024), 5函数 log-domain 1024枚举, D1-D10 十不变量, A1-A6 audit, f1.3 NOT_MEASURED)
...
- **Branch**: `formal-ir-mainline`；`HEAD` `TBD_new_plan_SHA` (implementation TBD, provenance deviation registry/report 9825d0b336042ad4bf2b26ed31b7fa09a04de620 vs 9bc34be6) 重核，不一致阻塞；已与`git rev-parse HEAD`一致。`TBD` 0 hits。
...
A3 channel_binding: channel_model_sha256 == selection_manifest.channel_model_sha256 PASS/FAIL
