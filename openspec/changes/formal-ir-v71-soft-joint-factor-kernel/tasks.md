...
**HEAD**: `e038114db5095a57158b0e1cd36884d6a1a5d8be` (动态绑定 `git rev-parse HEAD`; 已修正历史静态偏差 `历史三头` vs predecessor 9bc34be6) + data `84d62779` — **rev A1 workload对应 kernel_calls 1/9/1024 (1->1, 9->9, 1024->1024) deterministic / A2 去self比较需真接口否则 ADAPTER_REQUIRED / A3 backend_model_binding 三状态分离 2M NO_INFORMATION (capacity FEASIBLE/MARGINAL/NO_INFORMATION)**
