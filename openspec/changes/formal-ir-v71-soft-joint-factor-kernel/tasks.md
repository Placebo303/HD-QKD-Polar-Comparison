...
**HEAD**: `e8c44e6eeb2343e00f78f15a3d551f8d9793088e` (动态绑定 `git rev-parse HEAD`; 已修正历史静态偏差 `历史三头` vs predecessor 9bc34be6) + data `84d62779` — **rev A1 1/9/1024 各1024次 deterministic / A2 去self比较需真接口否则 ADAPTER / A3 三状态分离 2M NO_INFORMATION_MARGIN**
