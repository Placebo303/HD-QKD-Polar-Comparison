...
**HEAD**: `6bc06d4d271b2418c5bfa6160f7840b58fc66b60` (动态绑定 `git rev-parse HEAD`; 已修正历史静态偏差 `历史三头` vs predecessor 9bc34be6) + data `84d62779` — **rev A1 1/9/1024 各1024次 deterministic / A2 去self比较需真接口否则 ADAPTER_REQUIRED / A3 三状态分离 2M NO_INFORMATION (capacity FEASIBLE/MARGINAL/NO_INFORMATION)**
