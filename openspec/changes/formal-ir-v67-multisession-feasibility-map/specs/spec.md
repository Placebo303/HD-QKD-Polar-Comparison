...
**Change**: `formal-ir-v67-multisession-feasibility-map` (`V67-MAP`, branch `formal-ir-mainline`, HEAD `TBD → 新 Plan SHA`, data `84d62779`, ≤9 sessions)
...
- **Branch**: `formal-ir-mainline`；`HEAD` `TBD → 新 Plan SHA` 重核，不一致阻塞；本次推送新 SHA 后停止。
...
elif λ_at_boundary or ΔNLL>0.50 or ValNLL>H_cal+1.0 or q_mass_unseen>1% or not isfinite(ValNLL):
...
S1_CE1, S1_CE2, S1_CE_full, S1_chain_delta, S1_lambda, S1_lambda_at_boundary, S1_DeltaNLL, S1_ValNLL, S1_H_cal, S1_q_mass_unseen, S1_effective_contexts, S1_m1_raw, S1_m2_raw, S1_raw_disclosure, S1_m1_family, S1_m2_family,
S2_CE1, S2_CE2, S2_CE_full, S2_chain_delta, S2_lambda, S2_lambda_at_boundary, S2_DeltaNLL, S2_ValNLL, S2_H_cal, S2_q_mass_unseen, S2_m1_raw, S2_m2_raw, S2_raw_disclosure, S2_m1_family, S2_m2_family,
