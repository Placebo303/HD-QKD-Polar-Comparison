...
**Cycle**: `V72P0-SYN` (soft-joint-binary-synthetic P0), predecessor `V71-SJK (487be113)` + `V70-BSJ (9bc34be6)` + `V70R1 (0509d10b CHANGES)`，HEAD `8fce6550588d458870ef2d268209fc1c826d6077` (动态绑定 `git rev-parse HEAD`; 2M 禁止, 9036×10240 mother 仅合成, V70/V71 零改) data `84d62779` 单点 `d1024 bw200 nearest legacy_v1` + `synthetic_v72p0`
