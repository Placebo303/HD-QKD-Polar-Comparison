...
def test_per_layer_boundary():
    ...
    m1, full1 = v57._per_layer_m(H_high)
    m2, full2 = v57._per_layer_m(H_low)
...
def test_dual_vs_single_gate():
    ...
    m1, _ = v57._per_layer_m(4.0)  # 1024
    m2, _ = v57._per_layer_m(1.0)  # ~267
...
def test_zero_and_cap():
    # edge: H=0 → 0
    m0, f0 = v57._per_layer_m(0.0)
    assert m0 == 0 and f0 is False
    # H very high → still capped 1024
    m_high, f_high = v57._per_layer_m(10.0)  # ceil huge >1024
