...
- [x] T0 — Baseline/read-only audit (reuse prior T0 per A1.3 after fresh recheck:
...
- [x] T1 — Freeze OpenSpec (proposal/design/tasks/spec) + `D7_B_PREREG_R1.md` +
  ...
  (plan); no push
- [x] T2 — Minimal implementation (`v72p2d7_gf32_easy_regime.py`, focused test
...
- [x] T3 — Qualification: py_compile → focused D7-B → D7-A regression →
...
- [x] T5 — Independent Pre-EXECUTE review (branch/commits, D7-A dep, 64 cells/
...
- [x] T6 — Closeout: scoped local commits (plan → impl → reviews → closeout),
...
- [x] T7 — WSL local-source launch rework (zero-decoder, no new UUID, no
