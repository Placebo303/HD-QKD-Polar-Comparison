# V72P2 task and acceptance matrix

- [ ] P0: Freeze plan and exact file manifest; verify base/remote/data availability.
- [ ] I1: Minimal runner, narrow adapter correction, focused tests; no real execution.
- [ ] T0: py_compile all four task Python files; existing frozen fields/mother tests pass.
- [ ] T1-A: First warm residual equals actual c2v delta; final APP/factor/hard/syndrome match independent final-message recomputation on a small sparse graph with nonuniform1024-state prior.
- [ ] T1-B: Fake runner checks prefix CSR, old-edge carry/new-edge zero, block reset;720 cap including718->2 and zero->no call/publication.
- [ ] T1-C: Current syndrome+tag conjunction; last legal candidate can pass; stale final scan cannot replace decisions; oracle never influences prior/acceptance; accepted-wrong isolated.
...
- [ ] C0: Memory-agent triage, then exact-add accepted compact artifacts/records and ordinary push. No qualification/promotion or successor execution.
