...
**Implementation SHA**: `c771cdc42a499bc24817b209834576259b8316f6` (HEAD == origin/formal-ir-mainline — must equal --authorized-target-sha at EXECUTE)
...
|------|-------|----------|--------|
| G0 HEAD/origin binding | `git rev-parse HEAD == origin/formal-ir-mainline == --authorized-target-sha == c771cdc42a499bc24817b209834576259b8316f6` | 40-char match | PASS |
