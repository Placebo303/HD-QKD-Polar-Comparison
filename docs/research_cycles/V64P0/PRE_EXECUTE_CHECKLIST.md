...
**Implementation SHA**: `cbc878e90b8ae231732374c798a1ba769e0e2f88` (HEAD == origin/formal-ir-mainline — must equal --authorized-target-sha at EXECUTE)
...
|------|-------|----------|--------|
| G0 HEAD/origin binding | `git rev-parse HEAD == origin/formal-ir-mainline == --authorized-target-sha == cbc878e90b8ae231732374c798a1ba769e0e2f88` | 40-char match | PASS |
