...
**Plan commit**: resolved externally by independent PRE-EXECUTE record; execution SHALL bind the authorized full SHA
**Predecessor implementation SHA**: `c771cdc42a499bc24817b209834576259b8316f6` → `5c26ef80dce8f90f1a81929896ded0ba45a541bc` (history only, not binding)
...
|------|-------|----------|--------|
| G0 HEAD/origin binding | `git rev-parse HEAD == origin/formal-ir-mainline == --authorized-target-sha` (resolved externally, 40-char match) | 40-char match | PASS |
