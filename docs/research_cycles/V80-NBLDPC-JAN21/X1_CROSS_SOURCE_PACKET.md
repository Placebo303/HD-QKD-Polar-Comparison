...
- Corrected verdicts (use these, NOT the review's plug-in-only table): 1M **OUT@208** (~9σ beyond CI, genuine) but **IN@200 (f=1.29300, N=2051) / @199 (f=1.28692, N=1098)**; 1.5M **INDETERMINATE@208** (0.82896 is 0.00037 below 0.829327, inside CI half-width 0.00221) but **IN@200 (1.25345, N=309) / @199 (1.24756, N=274)**; 2M **IN@208** (1.29181, N=1754) / @200 (1.24501, N=262) / @199 (1.23916, N=236).
