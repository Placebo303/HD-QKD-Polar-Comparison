...
- [results/authoritative/_tmp_minrerun_stageC_security_20dB/security_calibrated_master_table_20dB_refined.csv](../results/authoritative/_tmp_minrerun_stageC_security_20dB/security_calibrated_master_table_20dB_refined.csv)
- [results/authoritative/_tmp_minrerun_stageC_security_20dB/stageC_summary.txt](../results/authoritative/_tmp_minrerun_stageC_security_20dB/stageC_summary.txt)

Refined cross-loss result:
- [results/authoritative/_tmp_minrerun_stageD_cross_loss/cross_loss_security_master_table_refined.csv](../results/authoritative/_tmp_minrerun_stageD_cross_loss/cross_loss_security_master_table_refined.csv)
- [results/authoritative/_tmp_minrerun_stageD_cross_loss/stageD_summary.txt](../results/authoritative/_tmp_minrerun_stageD_cross_loss/stageD_summary.txt)
...
Refined summary:
- [stageC_summary.txt](../results/authoritative/_tmp_minrerun_stageC_security_20dB/stageC_summary.txt)
...
- [stageD_summary.txt](../results/authoritative/_tmp_minrerun_stageD_cross_loss/stageD_summary.txt)
