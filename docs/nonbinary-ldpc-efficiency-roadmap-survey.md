...
| Tang / Liu / Yu / Wu, *Shannon-limit approached IR for QKD*（期刊版 Quantum Inf. Process. 2021，[DOI](https://doi.org/10.1007/s11128-020-02919-8)；预印本 [arXiv:2003.03713](https://arxiv.org/abs/2003.03713) 2020，polar SLA；same NUDT group as the AIR-polar work, PhysRevApplied 18.044022） | f = 1.055–1.091（QBER 0.02–0.1，128Mb 块） | DV-QKD 实际系统的效率标杆（大块长）；小块的有限长代价是普适约束 |
...
| 后续工作（2025，flagged for reading）：*Performance of Cascade and LDPC Codes for IR on Industrial QKD Systems*（[IET QT, DOI](https://doi.org/10.1049/qtc2.70003)；**数字未核实（无全文），引用前必须线下取 PDF**）；*Adaptation of Error Correction Procedures to the Time-Bin QKD Protocol Implementation*（[IEEE Access 2025](https://doi.org/10.1109/access.2025.3648803)） | — | 工业系统落地 + time-bin 纠错适配，与本项目真实 time-bin 数据最贴近的两篇后续 |
