...
- Implemented bounded q-ary OSD-0/1 (`nonbinary_v19_osd.py`) and integrated it
  ...
  - n=64 fast OSD-1..10 batches: 18/64 exact overall, FER=0.71875
  ...
  - n=64 fast OSD with lambda `{2:0.6,3:0.4}`: 15/32 exact, FER=0.53125
    (`..._fast_osd_lambdab_8f_2136/`, `..._fast_osd_lambdab_8f_2144/`,
    `..._fast_osd_lambdab_8f_2192/`, `..._fast_osd_lambdab_8f_2252/`).
    At n=128 the same lambda gave 0/4 exact, FER=1.0
    (`..._fast_osd_lambdab_4f_2200/`).
  ...
  - Full OSD-1 at n=64, m=4, f≈1.136 recovered 5/16 frames
    (`..._full_osd1_n64_probe*.json` and `..._fast_osd_4f_*`), FER=0.6875.
    Prior-retry + full OSD-1
    and broad
    OSD-2 on a
