"""Route B (nbldpc_formal_v5b_mother) formal qualification lane.

Binds the shared v5 runtime to the frozen Route B contract: run ID, roots,
caps, source provenance, and the v5b core.  Plan/execute/verify semantics are
the v4-proven lifecycle (see :mod:`nonbinary_v5_runtime`).
"""
from __future__ import annotations

from . import nonbinary_v5_runtime as runtime
from . import nonbinary_v5b_multistage as core

RUN_ID = "20260731_v5b_nbldpc_mother_synthetic"
ROOTS = {("development", .20): 202607760000, ("development", .30): 202607770000,
         ("confirmation", .20): 202607780000, ("confirmation", .30): 202607790000}
...
_SRC = ("comparison_bench/src/comparison_bench/formal_ir/nonbinary_v5_runtime.py",
        ...
        "comparison_bench/src/comparison_bench/formal_ir/nonbinary_v5b_multistage.py",
        "comparison_bench/src/comparison_bench/formal_ir/nonbinary_v5b_ir_qualification.py",
        "comparison_bench/src/comparison_bench/cli/run_formal_nonbinary_v5b_qualification.py",
...
CONFIG = runtime.RouteConfig(
    run_id=RUN_ID, canonical_schema="NBLDPCQ5B", method=core.METHOD,
