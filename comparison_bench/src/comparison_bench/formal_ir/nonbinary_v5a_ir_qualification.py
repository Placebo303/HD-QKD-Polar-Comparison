"""Route A (nbldpc_formal_v5a_multistage) formal qualification lane.

Binds the shared v5 runtime to the frozen Route A contract: run ID, roots,
caps, source provenance, and the v5a core.  Plan/execute/verify semantics are
the v4-proven lifecycle (see :mod:`nonbinary_v5_runtime`).
"""
from __future__ import annotations

from . import nonbinary_v5_runtime as runtime
from . import nonbinary_v5a_multistage as core

RUN_ID = "20260731_v5a_nbldpc_multistage_synthetic"
ROOTS = {("development", .20): 202607720000, ("development", .30): 202607730000,
         ("confirmation", .20): 202607740000, ("confirmation", .30): 202607750000}
...
_SRC = ("comparison_bench/src/comparison_bench/formal_ir/nonbinary_v5_runtime.py",
        ...
        "comparison_bench/src/comparison_bench/cli/run_formal_nonbinary_v5a_qualification.py",
...
CONFIG = runtime.RouteConfig(
    run_id=RUN_ID, canonical_schema="NBLDPCQ5A", method=core.METHOD,
