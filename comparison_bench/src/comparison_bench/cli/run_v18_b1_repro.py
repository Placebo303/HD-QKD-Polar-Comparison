"""CLI for V18-B1 small-q DE reproduction (smoke + production)."""
...
def main() -> int:
    ...
    if args.mode == "m1b":
        ...
        seed = core.SMOKE_SEED if args.seed is None else args.seed
        doc = core.run_smoke(q=args.q, out_dir=out, seed=seed)
    summary = {"schema": doc["schema"], "q": doc["q"], "mode": doc["mode"]}
    if args.mode == "production":
        summary["reproduction"] = doc["reproduction"]
