"""V22b high-degree structured DE gate CLI (diagnostic)."""
...
from ..formal_ir.nonbinary_v22b_de_gate import run_v22b_de_gate
...
def main() -> int:
    ...
    ap.add_argument("--degree-max", type=int, default=128)
    ...
    doc = run_v22b_de_gate(q=args.q, w=w, rate=args.rate,
                           candidates=candidates,
                           n_samples=args.n_samples, max_iter=args.max_iter,
                           seed=args.seed, degree_max=args.degree_max,
