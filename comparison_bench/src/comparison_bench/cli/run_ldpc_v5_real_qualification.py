"""Immutable v1 fresh real qualification package runner for binary LDPC v5.
...
from ..formal_ir.ldpc_v5_real_qualification import execute_plan, prepare_plan
...
def main() -> int:
    ...
    p = argparse.ArgumentParser(description="binary LDPC v5 real qualification package runner")
