...
import numpy as np
from comparison_bench.src.comparison_bench.cli import run_ldpc_v4_10db_transfer_qualification as lane
from comparison_bench.src.comparison_bench.cli import verify_ldpc_v4_10db_transfer_qualification as verify
...
class TestTransfer10dB(unittest.TestCase):
 def setUp(self):
